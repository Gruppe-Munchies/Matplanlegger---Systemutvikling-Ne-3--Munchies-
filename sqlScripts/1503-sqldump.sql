...
ALTER TABLE munchbase.recipe_has_ingredient
    ADD CONSTRAINT fk_recipe_has_ingredient_recipe1 FOREIGN KEY (`recipe_idRecipe`) REFERENCES munchbase.recipe (`idRecipe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE munchbase.`recipe_has_weeklyMenu`
    ADD CONSTRAINT `fk_recipe_has_weeklyMenu_recipe1` FOREIGN KEY (`recipe_idRecipe`) REFERENCES munchbase.recipe (`idRecipe`) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE munchbase.`recipe_has_weeklyMenu`
    ADD CONSTRAINT `fk_recipe_has_weeklyMenu_weeklyMenu1` FOREIGN KEY (`weeklyMenu_year`, `weeklyMenu_weekNum`) REFERENCES munchbase.`weeklyMenu` (year, `weekNum`) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE munchbase.`userGroup_has_ingredient`
    ADD CONSTRAINT `fk_userGroup_has_ingredient_ingredient1` FOREIGN KEY (ingredient_idingredient) REFERENCES munchbase.ingredient (idingredient) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE munchbase.`weeklyMenu`
    ADD CONSTRAINT `fk_weeklyMenu_userGroup1` FOREIGN KEY (`userGroup_iduserGroup`) REFERENCES munchbase.`userGroup` (`iduserGroup`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
INSERT INTO munchbase.`user`(username, email, firstname, lastname, password)
VALUES ('testebruker', 'test@test.no', 'Test', 'Bruker', 'hemmeligegreier');
